...
def read_words(data):
    words = list(data.q_cut) + list(data.a_cut)
    words_all = []
    for word in words:
...
def save_my_w2v(path):
    ...
    vectors, iw, wi, dim = read_vectors('D:\\Jupyter\\NLP\\Embedding\\Chineses\\sgns.zhihu.word', 0)
...
if __name__ == '__main__':
    ...
    #================预训练=====================================================
    #load_pre_train_w2v('D:\\Jupyter\\NLP\\运用文本相似度实现（证券）智能客服【恒生电子】\\模仿第一个atec\\data\\cache\\train_cut.csv')
